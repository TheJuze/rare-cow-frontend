 ...
 * * l - empty
 * @param {(default, secondary, error, gray6, dark, dark0, dark1, accent, light1, light3, iris100, metal50, metal600, metal700, metal800)} [color] - color of the font `initial = default`
 * * default - $metal500
 * * secondary - $metal500
 * * error - $red
 * * gray6 - $gray-6
